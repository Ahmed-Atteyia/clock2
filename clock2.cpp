...
void main()
{
 ...
 floodfill(x,y,15);
 settextstyle(4,0,5);
 outtextxy(x-20,y-195,"12");
 outtextxy(x+195*cos(-M_PI/3.0-0.1),y+195*sin(-M_PI/3.0-0.1),"1");
 outtextxy(x+183*cos(-M_PI/6.0-0.17),y+183*sin(-M_PI/6.0-0.17),"2");
 outtextxy(x+168,y-28,"3");
 outtextxy(x+153*cos(M_PI/6.0-0.17),y+153*sin(M_PI/6.0-0.17),"4");
 outtextxy(x+145*cos(M_PI/3.0-0.05),y+145*sin(M_PI/3.0-0.05),"5");
 outtextxy(x-10,y+142,"6");
 outtextxy(x+155*cos(2*M_PI/3.0+0.15),y+155*sin(2*M_PI/3.0+0.15),"7");
 outtextxy(x+170*cos(5*M_PI/6.0+0.2),y+170*sin(5*M_PI/6.0+0.2),"8");
 outtextxy(x-186,y-28,"9");
 outtextxy(x+183*cos(-5*M_PI/6.0+-0.1),y+183*sin(-5*M_PI/6.0+0.1),"10");
 outtextxy(x+200*cos(-2*M_PI/3.0-0.02),y+200*sin(-2*M_PI/3.0-0.02),"11");
 settextstyle(4,0,5);
